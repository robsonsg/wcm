import{w as b}from"./chunk-RLCM72IK.js";import{Ca as u,Ec as g,Ib as n,Vb as s,a as d,aa as m,ab as h,b as c,ga as p,xb as o,yb as a}from"./chunk-27GLVKKX.js";var S=(()=>{class l{toasts=u([]);toasts$=this.toasts.asReadonly();generateId(){return Math.random().toString(36).substring(2,9)}createToast(e){return{id:e.id||this.generateId(),title:e.title||"",message:e.message,type:e.type||"info",duration:e.duration||5e3,closeable:e.closeable!==!1,showTime:e.showTime!==!1,position:e.position||"top-end",showProgressBar:e.duration&&e.duration>0?e.showProgressBar||!0:!1,timestamp:new Date,details:e.details,showDetailsButton:e.showDetailsButton!==!1&&!!e.details,detailsButtonText:e.detailsButtonText||"Ver Detalhes"}}show(e){let t=this.createToast(e);this.toasts.update(i=>[...i,t])}success(e,t){this.show(c(d({},t),{message:e,type:"success"}))}error(e,t){this.show(c(d({},t),{message:e,type:"error"}))}warning(e,t){this.show(c(d({},t),{message:e,type:"warning"}))}info(e,t){this.show(c(d({},t),{message:e,type:"info"}))}patientAlert(e,t,i){this.show(c(d({},i),{message:e,type:"warning",title:"Alerta do Paciente",details:t,duration:0,detailsButtonText:"Ver Protocolo"}))}medicalError(e,t,i){this.show(c(d({},i),{message:e,type:"error",title:"Erro M\xE9dico",details:t,duration:0,detailsButtonText:"Ver Logs"}))}treatmentSuccess(e,t,i){this.show(c(d({},i),{message:e,type:"success",title:"Tratamento Conclu\xEDdo",details:t,detailsButtonText:"Ver Relat\xF3rio"}))}systemInfo(e,t,i){this.show(c(d({},i),{message:e,type:"info",title:"Informa\xE7\xE3o do Sistema",details:t,detailsButtonText:"Detalhes T\xE9cnicos"}))}remove(e){this.toasts.update(t=>t.filter(i=>i.id!==e))}clear(){this.toasts.set([])}positions=g(()=>{let e=this.toasts$();return[...new Set(e.map(i=>i.position))]});getToastsByPosition(e){return this.toasts$().filter(t=>t.position===e)}getContainerClasses(e){let t="fixed z-50 pointer-events-none",i="space-y-2 p-4",r={"top-start":"top-5 left-0","top-center":"top-5 left-1/2 transform -translate-x-1/2","top-end":"top-5 right-0","middle-start":"top-1/2 left-0 transform -translate-y-1/2","middle-center":"top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2","middle-end":"top-1/2 right-0 transform -translate-y-1/2","bottom-start":"bottom-0 left-0","bottom-center":"bottom-0 left-1/2 transform -translate-x-1/2","bottom-end":"bottom-0 right-0"};return`${t} ${i} ${r[e]||r["top-end"]}`}static \u0275fac=function(t){return new(t||l)};static \u0275prov=m({token:l,factory:l.\u0275fac,providedIn:"root"})}return l})();var D=(()=>{class l{toastService=p(S);showSuccess(){this.toastService.success("Opera\xE7\xE3o realizada com sucesso!")}showError(){this.toastService.error("Erro ao processar a solicita\xE7\xE3o")}showWarning(){this.toastService.warning("Aten\xE7\xE3o: Verificar dados antes de continuar")}showInfo(){this.toastService.info("Informa\xE7\xE3o importante para o usu\xE1rio")}showPatientAlert(){this.toastService.patientAlert("Paciente Jo\xE3o Silva apresenta sinais de instabilidade",{title:"Protocolo de Emerg\xEAncia - Paciente Jo\xE3o Silva",content:`DADOS DO PACIENTE:
Nome: Jo\xE3o Silva
Idade: 67 anos
...
- Emerg\xEAncia: SAMU 192`,type:"text",showTimestamp:!0,maxHeight:"500px"})}showVitalSignsAlert(){this.toastService.medicalError("Sinais vitais cr\xEDticos detectados",{title:"Alerta Cr\xEDtico - Monitoramento Vital",content:`{
  ...
  "recommendations": [
    ...
    "Preparar para poss\xEDvel transfer\xEAncia para UTI"
          ...
          </div>`,type:"html"}})}showJsonDetails(){this.toastService.info("Dados t\xE9cnicos dispon\xEDveis",{details:{title:"Dados JSON",content:JSON.stringify({user:"Jo\xE3o Silva",timestamp:new Date().toISOString(),data:{vitals:{heartRate:72,bloodPressure:"120/80",temperature:36.5},medications:[{name:"Losartana",dose:"50mg",frequency:"1x/dia"},{name:"Metformina",dose:"850mg",frequency:"2x/dia"}]}}),type:"json"}})}showWithActions(){this.toastService.warning("A\xE7\xE3o necess\xE1ria do usu\xE1rio",{details:{title:"A\xE7\xF5es Dispon\xEDveis",content:"Este exemplo mostra como adicionar bot\xF5es de a\xE7\xE3o no modal de detalhes.",actions:[{label:"Aprovar",action:()=>{this.toastService.success("A\xE7\xE3o aprovada!")},type:"success"},{label:"Rejeitar",action:()=>{this.toastService.error("A\xE7\xE3o rejeitada!")},type:"error"},{label:"Mais Info",action:()=>{this.toastService.info("Informa\xE7\xF5es adicionais...")},type:"primary"}]}})}clearAll(){this.toastService.clear()}static \u0275fac=function(t){return new(t||l)};static \u0275cmp=h({type:l,selectors:[["app-toast-demo"]],decls:44,vars:0,consts:[[1,"min-h-screen","bg-gray-100","p-8"],[1,"max-w-4xl","mx-auto"],[1,"text-3xl","font-bold","text-gray-900","mb-8"],[1,"bg-white","rounded-lg","shadow-md","p-6","mb-8"],[1,"text-xl","font-semibold","text-gray-800","mb-4"],[1,"grid","grid-cols-1","md:grid-cols-2","lg:grid-cols-4","gap-4"],[1,"btn","btn-success",3,"click"],[1,"btn","btn-error",3,"click"],[1,"btn","btn-warning",3,"click"],[1,"btn","btn-info",3,"click"],[1,"grid","grid-cols-1","md:grid-cols-2","gap-4"],[1,"bg-white","rounded-lg","shadow-md","p-6"],[1,"btn","btn-primary",3,"click"],[1,"btn","btn-ghost",3,"click"]],template:function(t,i){t&1&&(o(0,"div",0)(1,"div",1)(2,"h1",2),s(3,"Sistema de Notifica\xE7\xF5es - Homecare"),a(),o(4,"div",3)(5,"h2",4),s(6,"Notifica\xE7\xF5es B\xE1sicas"),a(),o(7,"div",5)(8,"button",6),n("click",function(){return i.showSuccess()}),s(9," Sucesso "),a(),o(10,"button",7),n("click",function(){return i.showError()}),s(11," Erro "),a(),o(12,"button",8),n("click",function(){return i.showWarning()}),s(13," Aviso "),a(),o(14,"button",9),n("click",function(){return i.showInfo()}),s(15," Informa\xE7\xE3o "),a()()(),o(16,"div",3)(17,"h2",4),s(18,"Notifica\xE7\xF5es com Detalhes - Homecare"),a(),o(19,"div",10)(20,"button",8),n("click",function(){return i.showPatientAlert()}),s(21," Alerta de Paciente "),a(),o(22,"button",7),n("click",function(){return i.showMedicalError()}),s(23," Erro M\xE9dico "),a(),o(24,"button",6),n("click",function(){return i.showTreatmentSuccess()}),s(25," Tratamento Conclu\xEDdo "),a(),o(26,"button",9),n("click",function(){return i.showSystemInfo()}),s(27," Info do Sistema "),a(),o(28,"button",8),n("click",function(){return i.showMedicationAlert()}),s(29," Alerta de Medica\xE7\xE3o "),a(),o(30,"button",7),n("click",function(){return i.showVitalSignsAlert()}),s(31," Sinais Vitais Cr\xEDticos "),a()()(),o(32,"div",11)(33,"h2",4),s(34,"Exemplos Avan\xE7ados"),a(),o(35,"div",10)(36,"button",9),n("click",function(){return i.showHtmlDetails()}),s(37," Detalhes HTML "),a(),o(38,"button",9),n("click",function(){return i.showJsonDetails()}),s(39," Detalhes JSON "),a(),o(40,"button",12),n("click",function(){return i.showWithActions()}),s(41," Com A\xE7\xF5es "),a(),o(42,"button",13),n("click",function(){return i.clearAll()}),s(43," Limpar Tudo "),a()()()()())},dependencies:[b],encapsulation:2})}return l})();export{D as ToastDemoComponent};
